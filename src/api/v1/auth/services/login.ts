...
const login = async (
    ...
    if (user.account.password === null) throw 'Phải đăng nhập bằng google và đổi lại mật khẩu!'

    if (user.account.password && (await comparePassword(password, user.account.password)) === false)
