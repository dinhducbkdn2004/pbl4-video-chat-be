...
const created = (res: Response, data: object | Array<object>, message: string) =>
...
const notFound = (res: Response, message: string) => responseWithData(res, { statusCode: 404, message, isOk: false })

const badRequest = (res: Response, message: string) => responseWithData(res, { statusCode: 400, message, isOk: false })

const badRequestWithData = (res: Response, message: string, data: object | Array<object>) =>
